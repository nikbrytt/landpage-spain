        ...
        <div className="container">
            <div className="projectLanPage__info">
                <div className="projectLanPage__info-texts">
                    ...
                    <p className="projectLanPage__info-descr">Подборка объектов на Коста-дель-Соль представляет собой разнообразную и внушительную коллекцию недвижимости, идеально подходящую для жизни, отдыха или инвестиций, сочетающую в себе роскошь, комфорт и доступность. Этот регион Испании известен своими живописными пейзажами, мягким климатом и развитой инфраструктурой, что делает его привлекательным выбором для покупателей со всего мира.</p>
                </div>
